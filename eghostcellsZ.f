        subroutine eghostcellsz(fnew,fdnew,
...
!-----------------periodic boundary conditions-----------------
        ...
        if(prock==0) then
                call mpi_send(fnew(1:nf,bx:fx,ly:ry,dzsl:dzsu),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgu,mpi_comm_world,ierr)
                call mpi_recv(fnew(1:nf,bx:fx,ly:ry,dzrl:dzru),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgd,mpi_comm_world,status,ierr)
        endif
        if(prock==nprocessx-1) then
                call mpi_recv(fnew(1:nf,bx:fx,ly:ry,uzrl:uzru),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgu,mpi_comm_world,status,ierr)
                call mpi_send(fnew(1:nf,bx:fx,ly:ry,uzsl:uzsu),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgd,mpi_comm_world,ierr)
        endif
!---------------------------------------------------------------
...
!--------------------periodic boundary conditions----------------
        ...
        if(prock==0) then
                call mpi_send(fdnew(1:nf,bx:fx,ly:ry,dzsl:dzsu),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgu,mpi_comm_world,ierr)
                call mpi_recv(fdnew(1:nf,bx:fx,ly:ry,dzrl:dzru),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgd,mpi_comm_world,status,ierr)
        endif
        if(prock==nprocessx-1) then
                call mpi_recv(fdnew(1:nf,bx:fx,ly:ry,uzrl:uzru),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgu,mpi_comm_world,status,ierr)
                call mpi_send(fdnew(1:nf,bx:fx,ly:ry,uzsl:uzsu),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgd,mpi_comm_world,ierr)
        endif
