...
!                call mpi_send(fnew(1:nscalar-1,bx:fx,ly:ry,uzsl:uzsu),
!     1                  ghostsize,mpi_double_precision,pidu,
!     2                  msgd,mpi_comm_world,ierr)
!        endif
!        if(prock/=0) then
!                call mpi_recv(fnew(1:nscalar-1,bx:fx,ly:ry,dzrl:dzru),
!     1                  ghostsize,mpi_double_precision,pidd,
!     2                  msgd,mpi_comm_world,status,ierr)
!                call mpi_send(fnew(1:nscalar-1,bx:fx,ly:ry,dzsl:dzsu),
!     1                  ghostsize,mpi_double_precision,pidd,
!     2                  msgu,mpi_comm_world,ierr)
!        endif
!        if(prock/=nprocessx-1) then
!                call mpi_recv(fnew(1:nscalar-1,bx:fx,ly:ry,uzrl:uzru),
!     1                  ghostsize,mpi_double_precision,pidu,
...
!-----------------periodic boundary conditions-----------------
        ...
        if(prock==0) then
                call mpi_send(f(1:nscalar,bx:fx,ly:ry,dzsl:dzsu),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgu,mpi_comm_world,ierr)
                call mpi_recv(f(1:nscalar,bx:fx,ly:ry,dzrl:dzru),
     1                  ghostsize,mpi_double_precision,pidubound,
     2                  msgd,mpi_comm_world,status,ierr)
        endif
        if(prock==nprocessx-1) then
                call mpi_recv(f(1:nscalar,bx:fx,ly:ry,uzrl:uzru),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgu,mpi_comm_world,status,ierr)
                call mpi_send(f(1:nscalar,bx:fx,ly:ry,uzsl:uzsu),
     1                  ghostsize,mpi_double_precision,piddbound,
     2                  msgd,mpi_comm_world,ierr)
        endif
!---------------------------------------------------------------
...
!        if(prock/=nprocessx-1) then
!                call mpi_send(fdnew(1:nscalar-1,bx:fx,ly:ry,uzsl:uzsu),
!     1                  ghostsize,mpi_double_precision,pidu,
!     2                  msgd,mpi_comm_world,ierr)
!        endif
!        if(prock/=0) then
!                call mpi_recv(fdnew(1:nscalar-1,bx:fx,ly:ry,dzrl:dzru),
!     1                  ghostsize,mpi_double_precision,pidd,
!     2                  msgd,mpi_comm_world,status,ierr)
!                call mpi_send(fdnew(1:nscalar-1,bx:fx,ly:ry,dzsl:dzsu),
!     1                  ghostsize,mpi_double_precision,pidd,
!     2                  msgu,mpi_comm_world,ierr)
!        endif
!        if(prock/=nprocessx-1) then
!                call mpi_recv(fdnew(1:nscalar-1,bx:fx,ly:ry,uzrl:uzru),
!     1                  ghostsize,mpi_double_precision,pidu,
!     2                  msgu,mpi_comm_world,status,ierr)
!        endif
!
