...
!=======================================================================
        ...
        real*8 f
        dimension f(nscalar,1:localsize,1:localsize,1:localsize)
        ...
        ghostsize=nscalar*6*localsize*localsize
...
!                call mpi_send(fnew(1:nscalar-1,fxsl:fxsu,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidf,
!     2                  msgb,mpi_comm_world,ierr)
!        endif
!        if(proci/=0) then
!                call mpi_recv(fnew(1:nscalar-1,bxrl:bxru,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidb,
!     2                  msgb,mpi_comm_world,status,ierr)
!                call mpi_send(fnew(1:nscalar-1,bxsl:bxsu,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidb,
!     2                  msgf,mpi_comm_world,ierr)
!        endif
!        if(proci/=nprocessx-1) then
!                call mpi_recv(fnew(1:nscalar-1,fxrl:fxru,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidf,
...
!-------------periodic boundary conditions----------------------
        ...
        if(proci==0) then
                call mpi_send(f(1:nscalar,bxsl:bxsu,ly:ry,dz:uz),
     1                  ghostsize,mpi_double_precision,pidfbound,
     2                  msgf,mpi_comm_world,ierr)
                call mpi_recv(f(1:nscalar,bxrl:bxru,ly:ry,dz:uz),
     1                  ghostsize,mpi_double_precision,pidfbound,
     2                  msgb,mpi_comm_world,status,ierr)
        endif
        if(proci==nprocessx-1) then
                call mpi_recv(f(1:nscalar,fxrl:fxru,ly:ry,dz:uz),
     1                  ghostsize,mpi_double_precision,pidbbound,
     2                  msgf,mpi_comm_world,status,ierr)
                call mpi_send(f(1:nscalar,fxsl:fxsu,ly:ry,dz:uz),
     1                  ghostsize,mpi_double_precision,pidbbound,
     2                  msgb,mpi_comm_world,ierr)
        endif
!---------------------------------------------------------------
...
!        if(proci/=nprocessx-1) then
!                call mpi_send(fdnew(1:nscalar-1,fxsl:fxsu,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidf,
!     2                  msgb,mpi_comm_world,ierr)
!        endif
!        if(proci/=0) then
!                call mpi_recv(fdnew(1:nscalar-1,bxrl:bxru,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidb,
!     2                  msgb,mpi_comm_world,status,ierr)
!                call mpi_send(fdnew(1:nscalar-1,bxsl:bxsu,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidb,
!     2                  msgf,mpi_comm_world,ierr)
!        endif
!        if(proci/=nprocessx-1) then
!                call mpi_recv(fdnew(1:nscalar-1,fxrl:fxru,ly:ry,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidf,
!     2                  msgf,mpi_comm_world,status,ierr)
!        endif
!
