...
!                call mpi_send(fnew(1:nscalar-1,bx:fx,rysl:rysu,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidr,
!     2                  msgl,mpi_comm_world,ierr)
!        endif
!        if(procj/=0) then
!                call mpi_recv(fnew(1:nscalar-1,bx:fx,lyrl:lyru,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidl,
!     2                  msgl,mpi_comm_world,status,ierr)
!                call mpi_send(fnew(1:nscalar-1,bx:fx,lysl:lysu,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidl,
!     2                  msgr,mpi_comm_world,ierr)
!        endif
!        if(procj/=nprocessx-1) then
!                call mpi_recv(fnew(1:nscalar-1,bx:fx,ryrl:ryru,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidr,
...
!---------------------periodic boundary conditions----------------------
        ...
        if(procj==0) then
                call mpi_send(f(1:nscalar,bx:fx,lysl:lysu,dz:uz),
     1                  ghostsize,mpi_double_precision,pidrbound,
     2                  msgr,mpi_comm_world,ierr)
                call mpi_recv(f(1:nscalar,bx:fx,lyrl:lyru,dz:uz),
     1                  ghostsize,mpi_double_precision,pidrbound,
     2                  msgl,mpi_comm_world,status,ierr)
        endif
        if(procj==nprocessx-1) then
                call mpi_recv(f(1:nscalar,bx:fx,ryrl:ryru,dz:uz),
     1                  ghostsize,mpi_double_precision,pidlbound,
     2                  msgr,mpi_comm_world,status,ierr)
                call mpi_send(f(1:nscalar,bx:fx,rysl:rysu,dz:uz),
     1                  ghostsize,mpi_double_precision,pidlbound,
     2                  msgl,mpi_comm_world,ierr)
        endif
...
!        if(procj/=nprocessx-1) then
!                call mpi_send(fdnew(1:nscalar-1,bx:fx,rysl:rysu,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidr,
!     2                  msgl,mpi_comm_world,ierr)
!        endif
!        if(procj/=0) then
!                call mpi_recv(fdnew(1:nscalar-1,bx:fx,lyrl:lyru,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidl,
!     2                  msgl,mpi_comm_world,status,ierr)
!                call mpi_send(fdnew(1:nscalar-1,bx:fx,lysl:lysu,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidl,
!     2                  msgr,mpi_comm_world,ierr)
!        endif
!        if(procj/=nprocessx-1) then
!                call mpi_recv(fdnew(1:nscalar-1,bx:fx,ryrl:ryru,dz:uz),
!     1                  ghostsize,mpi_double_precision,pidr,
!     2                  msgr,mpi_comm_world,status,ierr)
!        endif
!
