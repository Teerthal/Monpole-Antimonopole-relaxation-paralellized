...
!=======================================================================
      ...
      subroutine hatnderivatives(f,i,j,k,dfdx,dfdy,dfdz,
     1            d2fdx2,d2fdy2,d2fdz2,lxb,lyl,lzd)
      ...
      dimension dfdx(nscalar),dfdy(nscalar),dfdz(nscalar)
      dimension d2fdx2(nscalar),d2fdy2(nscalar),d2fdz2(nscalar)
